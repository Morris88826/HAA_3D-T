...
6. One can label a joint to be occluded/non-visible or non-occluded/visible by toggling (1). In label-everything mode (l), pressing (1) will change the joint to be non-visible, while pressing (3) will mark it visible. Users can also press (Mark all unoccluded/occluded) to change all joints to be visiblility, i.e., confidence score 1.
